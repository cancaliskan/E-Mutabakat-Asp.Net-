<%@ Page Title="" Language="C#" MasterPageFile="~/eMutabakat_MASTER.Master" AutoEventWireup="true" CodeBehind="KullaniciKaldir.aspx.cs" Inherits="eMutabakats_yonetim.KullaniciKaldir" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table style="width: 59.6253%; margin-left: auto; margin-right: auto;">
        <caption>
            <h3><b>KULLANICI KAPATMA EKRANI</b></h3>
        </caption>
        <tbody>
            <tr>
            ...
            <tr style="border-bottom: groove">
                ...
                <td style="width: 93%;">
                    ...
                    <asp:DropDownList ID="USERNAME" runat="server" AutoPostBack="True" Enabled="False">

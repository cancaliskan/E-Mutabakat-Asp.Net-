<%@ Page Title="" Language="C#" MasterPageFile="~/eMutabakat_MASTER.Master" AutoEventWireup="true" CodeBehind="FirmaEkle.aspx.cs" Inherits="eMutabakats_yonetim.FirmaEkle" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <%--<h1><b>FİRMA EKLENECEK</b></h1>--%>
    ...
    <table style="width: 59.6253%; margin-left: auto; margin-right: auto;">
        <caption>
            <h3><b>YENİ FİRMA EKLEME EKRANI</b></h3>
        </caption>
        <tbody>
            <tr>
            ...
            <tr style="border-bottom: groove">
                ...
                <td style="width: 93%;">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="FIRM_NAME" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>                
            ...
            <tr style="border-bottom: groove">
                ...
                <td style="width: 93%;">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="FIRM_CODE" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>                
                    <asp:TextBox ID="FIRM_CODE" Width="97%" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr style="border-bottom: groove">
                ...
                <td style="width: 93%; padding-left:6px">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="FIRM_IMAGE" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>                
            ...
            <tr style="border-bottom: groove">
                ...
                <td style="width: 93%; padding-left:6px">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="FIRM_IMAGE2" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>                
            ...
            <tr style="border-bottom: groove">
                ...
                <td style="width: 2%; text-align: center">:</td>
                <td style="width: 93%;">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="CARI_REP_PAGE" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>                
            ...
            <tr style="border-bottom: groove">
                ...
                <td style="width: 2%; text-align: center">:</td>
                <td style="width: 93%;">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="BA_BS_REP_PAGE" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>                
            ...
            <tr style="border-bottom: groove">
                ...
                <td style="width: 2%; text-align: center">:</td>
                <td style="width: 93%;">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="SMTP_SERVER" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>                
            ...
            <tr style="border-bottom: groove">
                ...
                <td style="width: 2%; text-align: center">:</td>
                <td style="width: 93%;">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="SENDER_EMAIL" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>                
            ...
            <tr style="border-bottom: groove">
                ...
                <td style="width: 2%; text-align: center">:</td>
                <td style="width: 93%;">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="SENDER_EMAIL_TEXT" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>                
            ...
            <tr style="border-bottom: groove">
                ...
                <td style="width: 2%; text-align: center">:</td>
                <td style="width: 93%;">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="EMAIL_USER" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>                
            ...
            <tr style="border-bottom: groove">
                ...
                <td style="width: 2%; text-align: center">:</td>
                <td style="width: 93%;">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="EMAIL_PASSWORD" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>                
                    <asp:TextBox ID="EMAIL_PASSWORD" Width="97%" runat="server" TextMode="Password"></asp:TextBox>
                </td>
            </tr>
            <tr style="border-bottom: groove">
                ...
                <td style="width: 2%; text-align: center">:</td>
                <td style="width: 93%;">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ControlToValidate="EMAIL_PORT" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>                
            ...
            <tr style="border-bottom: groove">
                ...
                <td style="width: 2%; text-align: center">:</td>
                <td style="width: 93%;">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ControlToValidate="WEB_LINK" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>                
            ...
            <tr style="border-bottom: groove">
                ...
                <td style="width: 2%; text-align: center">:</td>
                <td style="width: 93%;">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ControlToValidate="FIRMVD" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>                
            ...
            <tr style="border-bottom: groove">
                ...
                <td style="width: 2%; text-align: center">:</td>
                <td style="width: 93%;">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ControlToValidate="ANNOUNCEMENT_CODE" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>                
            ...
            <tr style="border-bottom: groove">
                ...
                <td style="width: 93%; padding-left:6px">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ControlToValidate="FIRM_IMAGE_MUHUR" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>                
            ...
            <tr style="border-bottom: groove">
                ...
                <td style="width: 2%; text-align: center">:</td>
                <td style="width: 93%;">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" ControlToValidate="FAX_NO" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>                
            ...
            <tr style="border-bottom: groove">
                ...
                <td style="width: 2%; text-align: center">:</td>
                <td style="width: 93%;">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator18" runat="server" ControlToValidate="MAIL_WAIT_TIME" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>                
                ...
                <tr style="border-bottom: groove">
                    ...
                    <td style="width: 2%; text-align: center">:</td>
                    <td style="width: 93%;">
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator19" runat="server" ControlToValidate="ACTCODE" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>                
            ...
            <tr>
                ...
                <td style="width: 93%;">
                    <asp:Button class="btn btn-primary btn-block btn-fla" ID="firmaEkle_btn" runat="server" Text="Ekle" OnClick="firmaEkle_btn_Click" />
                </td>
            </tr>
        </tbody>
    </table>
